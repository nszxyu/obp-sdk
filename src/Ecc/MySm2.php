...
use Xyz\Obp\Ecc\Crypto\Signature\Sm2Signer;
use Xyz\Obp\Ecc\Curves\MyNistCurve;
use Xyz\Obp\Ecc\SM2\Hex2ByteBuf;
use Xyz\Obp\Ecc\SM2\Sm2WithSm3;
...
class MySm2 {
    ...
    protected $formatSign = 'base64';
    //可扩展自定义多种返回签名方式
    protected $arrFormat = ['hex','base64'];

    function __construct($formatSign='hex') {
        $this->adapter = EccFactory::getAdapter();
        $this->generator = (new MyNistCurve($this->adapter))->generatorSm2();
